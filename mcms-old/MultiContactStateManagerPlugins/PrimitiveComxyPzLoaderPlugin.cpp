...
#include <MotionGenerator/MultiContactStateManager/MultiContactStatePrimitives/MCMS/PrimitiveComxyPzLoader.h>
...
{
  return new PrimitiveComxyPzLoader(parentManager, name, cmd_init);
}
